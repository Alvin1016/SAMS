...
try:
    # Get the local network IP address dynamically
    s = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
    s.connect(("8.8.8.8", 80))
    LOCAL_IP = s.getsockname()[0]  # e.g., "192.168.1.100"
    s.close()
...
INSTALLED_APPS = [
    ...
    'attendanceRecordingQR.apps.AttendancerecordingqrConfig',
]
...
EMAIL_PORT = 587  # Use 465 if you need SSL
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False
...
LOGIN_URL = '/attendanceRecordingQR/login/'